...
from wtforms import StringField, SelectField, SelectMultipleField, DateTimeField, TextField, RadioField
...
class VenueForm(FlaskForm):
    ...
    genres = SelectMultipleField(
        'genres', validators=[
            DataRequired(),
            Length(max=4, message="Select at most 4 Genres.")
        ],
        choices=[
